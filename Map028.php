...
.charIcon.enemy{border:2px solid #f44;box-shadow:0 0 8px #f33;}
...
<div class="left">
    ...
    <div class="map-wrap" id="mapWrap">
        ...
        <img id="char" class="char" src="data:image/svg+xml;utf8,
        ...
        <!-- Inimigos fixos -->
        <?php foreach($enemies as $en): ?>
            <div class="charIcon enemy" 
                 style="left:<?php echo $en['Xpos']*40 + 20; ?>px; top:<?php echo $en['Ypos']*40 + 20; ?>px;
                        background: #b00;" 
                 title="<?php echo htmlspecialchars($en['Name']); ?> (Lv <?php echo $en['Level']; ?>)&#10;HP: <?php echo $en['HP']; ?>/<?php echo $en['MaxHP']; ?>&#10;Elemento: <?php echo htmlspecialchars($en['Element']); ?>"
                 onclick="iniciarBatalha({EnemyID: <?php echo $en['EnemyID']; ?>, Name: '<?php echo $en['Name']; ?>'})">
            </div>
        <?php endforeach; ?>

        <!-- Outros jogadores online -->
        <?php foreach($charsOnline as $ch): 
            if($ch['CharID'] === $charID) continue; ?>
            <div class="charIcon other"
                 style="left:<?php echo $ch['Xpos']*40 + 20; ?>px; top:<?php echo $ch['Ypos']*40 + 20; ?>px;
                        background: #<?php echo str_pad(dechex((intval($ch['PlayerID'])*99999)&0xFFFFFF),6,'0',STR_PAD_LEFT); ?>"
                 title="<?php echo htmlspecialchars($ch['Name']); ?> (<?php echo htmlspecialchars($ch['Class']); ?>)&#10;Lv: <?php echo $ch['Level']; ?>&#10;HP: <?php echo $ch['HP']; ?>&#10;Mana: <?php echo $ch['Mana']; ?>">
            </div>
        <?php endforeach; ?>
    </div>
